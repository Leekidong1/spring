...
import com.springBatch.www1.Person;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "/com/springBatch/www1/job_beans3.xml" })
public class MyJobCsvToSqlTest {
